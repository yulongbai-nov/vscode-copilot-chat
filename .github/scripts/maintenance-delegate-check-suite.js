...
/**
 * Formats a check run into a human-readable string with status and summary.
 * @param {Object} run - The check run object from GitHub API
 * @returns {string} Formatted string representation of the check run
 */
...
/**
 * Searches for an existing comment with the given marker in a pull request.
 ...
 * @returns {Promise<Object|undefined>} The existing comment object or undefined if not found
 */
