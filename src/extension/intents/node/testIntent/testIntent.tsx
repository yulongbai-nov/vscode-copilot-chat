...
class RequestHandler extends DefaultIntentRequestHandler {
	constructor(
		...
		super(intent, conversation, request, stream, token, documentContext, location, chatTelemetry, undefined, undefined, onPaused, instantiationService, conversationOptions, telemetryService, logService, surveyService, requestLogger, editSurvivalTrackerService, authenticationService, endpointProvider, liveRequestEditorService);
	}
