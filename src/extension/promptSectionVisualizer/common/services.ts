...
export interface IContentRenderer {
	 ...
	 */
	extractCodeBlocks(content: string): Array<{ readonly code: string; readonly language?: string; readonly resource?: any; readonly markdownBeforeBlock?: string }>;
...
export interface ISectionEditorService extends IDisposable {
	 ...
	 */
	editSection(section: PromptSection, options?: any): Promise<string | undefined>;

	/**
	 * Edit section in a temporary document
	 */
	editSectionInDocument(section: PromptSection, options: any): Promise<string | undefined>;

	/**
	 * Edit section inline using quick input
	 */
	editSectionInline(section: PromptSection, options: any): Promise<string | undefined>;
	 ...
	 */
	getEditorState(sectionId: string): any | undefined;
...
export interface IPromptVisualizerController extends IDisposable {
	 ...
	 */
	renderInline(stream: any, options?: any): Promise<void>;

	/**
	 * Render using the current mode
	 */
	render(stream?: any, options?: any): Promise<void>;

	/**
	 * Handle chat context and follow-up interactions
	 */
	handleChatContext(context: any, request: any): Promise<void>;
