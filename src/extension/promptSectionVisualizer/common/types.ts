...
export interface TokenizationEndpoint {
	readonly tokenizer: string; // TokenizerType as string to avoid node import
}
...
export interface ContentDetectionResult {
	...
	codeBlocks: Array<{ readonly code: string; readonly language?: string; readonly resource?: any; readonly markdownBeforeBlock?: string }>;
	plainTextFallback: string;
}
